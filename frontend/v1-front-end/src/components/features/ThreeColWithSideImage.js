...
import defaultCardImage from "../../images/HeroBackground.png";
import { ReactComponent as SvgDecoratorBlob3 } from "../../images/svg-decorator-blob-3.svg";

import AIIconImage from "../../images/icons8-ai-64.png";
import ResumeIconImage from "../../images/icons8-resume-50.png";
import GPTIconImage from "../../images/icons8-chatgpt-30.png";

const Container = tw.div`relative`;

const ThreeColumnContainer = styled.div`
  ${tw` flex flex-col items-center md:items-stretch md:flex-row flex-wrap md:justify-center max-w-screen-lg mx-auto py-20 md:py-24 w-full max-w-screen-xl`}
`;
